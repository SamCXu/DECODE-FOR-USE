...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1550.280857618312; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2044.71934052409         ; // x position of the perpendicular encoder (in tick units)
    }
