...
public class BlueClose extends LinearOpMode {
    ...
    private void buildTrajectories() {
        TrajectoryActionBuilder trajectoryHolder = drive.actionBuilder(initialPose)
                ...
                .afterTime(0.8, all.runAllAutoAction(hardwareMap, telemetry, false, false))
                ...
                .afterTime(0.78, all.runAllAutoAction(hardwareMap, telemetry, false, false))
                .strafeToLinearHeading(new Vector2d(7, -55+10), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(7, -27+10), Math.toRadians(90))
                ...
                .strafeToLinearHeading(new Vector2d(29, -55+12), Math.toRadians(90))
